import { MonitoringService, monitoring, MetricData, HealthCheck, AlertRule } from '@/lib/monitoring/monitor';
...
describe('Monitoring System - Basic Tests', () => {
  ...
  describe('Report Generation', () => {
    ...
    it('should calculate summary statistics', () => {
      ...
      if (stats) { // Only check if stats exist (they might be filtered by time)
