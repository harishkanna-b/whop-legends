...
describe('WebhookSecurity System', () => {
  ...
  describe('Signature Validation', () => {
    it('should validate correct HMAC signature', () => {
      ...
      const result = WebhookSecurity.validateSignature(signature, payload, secret);
    ...
    it('should reject incorrect signature', () => {
      ...
      const result = WebhookSecurity.validateSignature('sha256=incorrect-signature', payload, 'test-secret-key-123');
    ...
    it('should handle multiple signature formats', () => {
      ...
      const result = WebhookSecurity.validateSignature(signatures, payload, secret);
      expect(result).toBe(true);
    });
  });
  ...
  describe('Security Threat Detection', () => {
    it('should detect SQL injection patterns', () => {
      ...
      const result = WebhookSecurity['scanForSecurityThreats'](maliciousPayload, JSON.stringify(maliciousPayload));
    ...
    it('should detect deeply nested objects', () => {
      ...
      const result = WebhookSecurity['scanForSecurityThreats'](deepPayload, JSON.stringify(deepPayload));
      expect(result.threatDetected).toBe(true);
    ...
    it('should allow clean payloads', () => {
      ...
      const result = WebhookSecurity['scanForSecurityThreats'](cleanPayload, JSON.stringify(cleanPayload));
  ...
  describe('Complete Webhook Validation', () => {
    ...
    it('should handle payload parsing errors gracefully', async () => {
      ...
      const result = await WebhookSecurity.validateWebhook(request, invalidPayload);
  ...
  describe('Security Configuration', () => {
    it('should allow configuration updates', () => {
      ...
      expect(updatedConfig.signatureAlgorithm).toBe(originalConfig.signatureAlgorithm);
    });
