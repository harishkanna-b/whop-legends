...
import { createUser, createReferral, getReferralsByUser, updateReferral } from '../../lib/database-utils';
...
describe('Referral Operations', () => {
  ...
  it('should create a new referral', async () => {
    ...
    expect(referral.referred_whop_user_id).toBe(testReferral.referred_whop_user_id);
