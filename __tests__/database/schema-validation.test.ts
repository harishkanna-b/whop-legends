...
describe('Database Schema Validation', () => {
  ...
  it('should have valid quest types', () => {
    ...
    const validTargetTypes = ['referrals', 'commission', 'level', 'achievements'];
    ...
    validTargetTypes.forEach(target => {
      expect(['referrals', 'commission', 'level', 'achievements']).toContain(target);
    });
  });
  ...
  it('should validate data model relationships', () => {
    ...
    expect(['users', 'referrals', 'user_quests', 'user_achievements', 'guild_members']).toContain('users');
