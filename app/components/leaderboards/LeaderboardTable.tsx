            ...
            <div>
              <p className="text-sm text-gray-700">
                ...
                <span className="font-medium">
                  {Math.min(pagination.currentPage * entries.length, pagination.totalEntries)}
                </span>{' '}
                of <span className="font-medium">{pagination.totalEntries.toLocaleString()}</span> results
              </p>
            </div>
            <div>
