...
import type { SocialStats } from "@/lib/social";
	...
	const loadStats = async () => {
		try {
			const response = await fetch(
				`/api/social/friends?userId=${userId}&action=stats`,
			);
		...
		<div className="space-y-6">
			...
			<div className="text-center">
				...
				<p className="text-gray-600 mt-2">
					Connect with friends, join teams, and build your community
				</p>
			</div>
			...
			<div className="min-h-screen">
				...
				{activeSection === "friends" && <FriendsList userId={userId} />}
				{activeSection === "teams" && <TeamsList userId={userId} />}
			</div>
