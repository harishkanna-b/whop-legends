			...
			<div className="p-6">
					...
					<div className="flex items-start space-x-3">
						...
						<div className="flex-1">
							...
							<div className="flex items-center space-x-2 mt-2">
								<span
									className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyColor(questData.difficulty)}`}
								>
									{questData.difficulty.charAt(0).toUpperCase() +
										questData.difficulty.slice(1)}
								</span>
				...
				<div className="mb-4">
					...
					<div className="flex justify-between text-xs text-gray-500 mt-1">
						<span>
							{progress?.current_value || 0} / {questData.target_value}{" "}
							{questData.target_type}
						</span>
						<span>
								...
								<div className="flex items-center">
									...
									<div>
										...
										<p className="text-lg font-bold text-blue-700">
											{questData.reward_xp.toLocaleString()} XP
										</p>
									</div>
								</div>
							</div>
								...
								<div className="flex items-center">
									...
									<div>
										...
										<p className="text-lg font-bold text-green-700">
											${questData.reward_commission.toFixed(2)}
										</p>
									</div>
								</div>
							</div>
