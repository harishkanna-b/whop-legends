				...
				<div className="bg-white rounded-lg shadow p-6">
					<div className="flex items-center">
						...
						<div className="ml-4">
							...
							<p
								className={`text-sm ${dashboardData.overview.member_growth_rate >= 0 ? "text-green-600" : "text-red-600"}`}
							>
								{dashboardData.overview.member_growth_rate >= 0 ? "↑" : "↓"}{" "}
								{Math.abs(dashboardData.overview.member_growth_rate).toFixed(1)}
								%
							</p>
						</div>
					</div>
				...
				<div className="bg-white rounded-lg shadow p-6">
					<div className="flex items-center">
						...
						<div className="ml-4">
							...
							<p
								className={`text-sm ${dashboardData.overview.revenue_growth_rate >= 0 ? "text-green-600" : "text-red-600"}`}
							>
								{dashboardData.overview.revenue_growth_rate >= 0 ? "↑" : "↓"}{" "}
								{Math.abs(dashboardData.overview.revenue_growth_rate).toFixed(
									1,
								)}
								%
							</p>
					...
					<div className="flex items-center">
						...
						<div className="ml-4">
							...
							<p className="text-sm text-gray-600">
								{formatPercentage(
									(dashboardData.overview.active_members /
										dashboardData.overview.total_members) *
										100,
								)}{" "}
								active
							</p>
				...
				<div className="bg-white rounded-lg shadow p-6">
					<div className="flex items-center">
						...
						<div className="ml-4">
							...
							<p className="text-2xl font-bold text-gray-900">
								{formatPercentage(
									dashboardData.overview.average_conversion_rate,
								)}
							</p>
						...
						{dashboardData.metrics.map((metric) => (
							...
							>
								<div className="flex items-center justify-between mb-2">
									...
									<span
										className={`text-sm font-medium ${getMetricColor(metric.change, metric.change_type)}`}
									>
								...
								>
									<div className="flex items-center space-x-4">
										...
										<div>
											...
											<p className="text-sm text-gray-600">
												{performer.character_class} • Level {performer.level}
											</p>
										</div>
									</div>
									<div className="text-right">
										...
										<p className="text-sm text-gray-600">
											{formatNumber(performer.total_referrals)} referrals
										</p>
									</div>
								</div>
							))}
							...
							>
								...
								<div className="text-right">
									<p className="text-sm font-medium text-gray-900">
										{activity.action.includes("commission")
