...
import { InsightsEngine, Insight } from '@/lib/analytics/insights-engine';
...
export function InsightsPanel({ companyId }: InsightsPanelProps) {
  ...
  const fetchInsights = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/insights/recommendations?companyId=${companyId}&${new URLSearchParams(filters as any)}`);
      if (response.ok) {
        ...
        setInsights(prev =>
          prev.map(insight =>
            insight.id === insightId
              ? { ...insight, acknowledged: true, acknowledged_at: new Date().toISOString() }
              : insight
          )
        );
        await fetchStats();
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">AI-powered insights to optimize your community</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.acknowledged_insights}</p>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-center">
      ...
      <div className="space-y-4">
        {insights.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Generate new insights to get AI-powered recommendations for your community.</p>
            <button
              onClick={generateNewInsights}
              disabled={generating}
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 capitalize">{selectedInsight.category}</p>
                  </div>
                </div>
                <button
              ...
              <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-medium capitalize">{selectedInsight.type}</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Priority:</span>
                        <span className={`ml-2 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getPriorityColor(selectedInsight.priority)}`}>
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  {selectedInsight.actionable && !selectedInsight.acknowledged && (
                    <button
                      onClick={() => {
