			...
			<div className="bg-white rounded-lg shadow p-6">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
					<div className="text-center">
						<div
							className={`text-3xl font-bold ${getUsageColor(metrics.cpu.usage)}`}
						>
					...
					<div className="text-center">
						<div
							className={`text-3xl font-bold ${getUsageColor(metrics.memory.usage)}`}
						>
					...
					<div className="text-center">
						<div
							className={`text-3xl font-bold ${getUsageColor(metrics.disk.usage)}`}
						>
					...
					<div className="space-y-4">
						<div>
							<div className="flex justify-between text-sm mb-2">
								...
								<span
									className={`font-medium ${getUsageColor(metrics.cpu.usage)}`}
								>
									{metrics.cpu.usage.toFixed(1)}%
								</span>
							</div>
					...
					<div className="space-y-4">
						<div>
							<div className="flex justify-between text-sm mb-2">
								...
								<span
									className={`font-medium ${getUsageColor(metrics.memory.usage)}`}
								>
									{metrics.memory.usage.toFixed(1)}%
								</span>
							</div>
					...
					<div className="space-y-4">
						<div>
							<div className="flex justify-between text-sm mb-2">
								...
								<span
									className={`font-medium ${getUsageColor(metrics.disk.usage)}`}
								>
									{metrics.disk.usage.toFixed(1)}%
								</span>
							</div>
