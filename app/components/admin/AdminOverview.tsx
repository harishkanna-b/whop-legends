...
export default function AdminOverview({ stats }: AdminOverviewProps) {
  ...
  const recentActivities = [
    { type: 'user_registration', message: 'New user registered: john_doe', time: '2 minutes ago' },
    { type: 'referral_completed', message: 'Referral completed: $50 commission earned', time: '5 minutes ago' },
    { type: 'achievement_unlocked', message: 'User unlocked "Social Butterfly" achievement', time: '8 minutes ago' },
    { type: 'team_created', message: 'New team created: "Champions"', time: '12 minutes ago' },
    { type: 'system_alert', message: 'System load above 80%', time: '15 minutes ago' }
  ]
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600">{stats.systemLoad.toFixed(1)}%</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600">
                {stats.activeUsers > 0 ? ((stats.totalReferrals / stats.activeUsers) * 100).toFixed(1) : 0}%
              </div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div
                className={`h-3 rounded-full transition-all duration-300 ${
                  stats.systemLoad > 80 ? 'bg-red-600' : stats.systemLoad > 60 ? 'bg-yellow-600' : 'bg-green-600'
                }`}
