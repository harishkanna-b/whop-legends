...
export default function UserManagement() {
  ...
  const handleUserAction = async (userId: string, action: 'ban' | 'activate' | 'reset') => {
    try {
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredUsers.map(user => (
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <span className="text-lg mr-2">{getCharacterClassIcon(user.characterClass)}</span>
                      <span className="text-sm text-gray-900 capitalize">{user.characterClass}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="mt-3">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedUser.level} ({selectedUser.totalXP} XP)</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Character Class</label>
                  <p className="text-sm text-gray-900 capitalize">{selectedUser.characterClass}</p>
                </div>
                <div>
