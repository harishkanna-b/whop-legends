...
export default function SystemSettings() {
	...
	const [activeTab, setActiveTab] = useState<
		"general" | "referral" | "security" | "notifications"
	>("general");
								...
								<div className="flex items-center justify-between">
									...
									<label className="relative inline-flex items-center cursor-pointer">
										<input
											...
											onChange={(e) =>
												updateSettings({ emailVerification: e.target.checked })
											}
											className="sr-only peer"
										/>
										<div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600" />
						...
						<div className="space-y-6">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div>
									...
									<input
										...
										onChange={(e) =>
											updateSettings({
												maxReferralCommission: Number.parseFloat(
													e.target.value,
												),
											})
										}
							...
							<div>
								...
								<input
									...
									onChange={(e) =>
										updateSettings({
											referralCookieDays: Number.parseInt(e.target.value),
										})
									}
									className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
								/>
								<p className="text-sm text-gray-500 mt-1">
									How long referral cookies persist
								</p>
							</div>
						</div>
					)}
											...
											<input
												...
												onChange={(e) =>
													updateSettings({
														rateLimiting: {
															...settings.rateLimiting,
															windowMs: Number.parseInt(e.target.value),
														},
													})
												}
												className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
