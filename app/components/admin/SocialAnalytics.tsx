			...
			<div className="grid grid-cols-1 md:grid-cols-5 gap-6">
				...
				<div className="bg-white rounded-lg shadow p-6">
					<div className="text-3xl font-bold text-purple-600">
						{formatNumber(stats.totalTeamMembers)}
					</div>
					...
					<div className="space-y-4">
						<div>
							<div className="text-2xl font-bold text-blue-600">
								{((stats.activeConnections / stats.totalFriends) * 100).toFixed(
									1,
								)}
								%
							</div>
					...
					<div className="space-y-4">
						<div>
							<div className="text-2xl font-bold text-purple-600">
								{stats.totalTeams > 0
									? formatNumber(
											Math.round(stats.totalTeamMembers / stats.totalTeams),
										)
									: 0}
							</div>
							<div className="text-sm text-gray-600">Avg Team Size</div>
						...
						<div>
							<div className="text-2xl font-bold text-yellow-600">
								{((stats.pendingRequests / stats.totalFriends) * 100).toFixed(
									1,
								)}
								%
							</div>
					...
					<div className="space-y-4">
						<div>
							<div className="text-2xl font-bold text-indigo-600">
								{stats.totalTeams > 0
									? ((stats.totalTeamMembers / stats.totalTeams) * 100).toFixed(
											1,
										)
									: "0.0"}
								%
