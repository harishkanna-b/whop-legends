...
async function handler(request: NextRequest) {
  try {
    ...
    const achievementStats = {
      ...
      unlockRate: 67.8,
      topAchievements: [
        { id: '1', name: 'First Steps', category: 'progression', rarity: 'common', unlocks: 15678 },
        { id: '2', name: 'Social Butterfly', category: 'social', rarity: 'rare', unlocks: 8234 },
        { id: '3', name: 'Referral Master', category: 'referral', rarity: 'legendary', unlocks: 1245 }
      ],
      categoryStats: [
        { category: 'progression', total: 45, unlocks: 34567, unlockRate: 76.5 },
