...
export class WebSocketService {
  ...
  subscribeToQuestUpdates(userId: string, callback: (message: WebSocketMessage) => void): string {
  ...
  subscribeToAnalyticsUpdates(companyId: string, callback: (message: WebSocketMessage) => void): string {
  ...
  subscribeToLeaderboardUpdates(leaderboardId: string, callback: (message: WebSocketMessage) => void): string {
  ...
  subscribeToUserUpdates(userId: string, callback: (message: WebSocketMessage) => void): string {
  ...
  subscribeToReferralUpdates(userId: string, callback: (message: WebSocketMessage) => void): string {
  ...
  subscribeToGuildUpdates(guildId: string, callback: (message: WebSocketMessage) => void): string {
...
export const useWebSocket = (subscriptionId: string, callback: (message: WebSocketMessage) => void) => {
  React.useEffect(() => {
