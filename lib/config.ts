		...
		return {
			...
			database: {
				url:
					...
					"postgresql://localhost:5432/whop_legends",
			...
			redis: {
				...
				retryDelay: Number.parseInt(process.env.REDIS_RETRY_DELAY || "1000"),
			...
			rateLimiting: {
				...
				defaultWindowMs: Number.parseInt(
			...
			webhook: {
				...
				timeoutMs: Number.parseInt(process.env.WEBHOOK_TIMEOUT_MS || "30000"),
