...
async function checkDatabaseStatus() {
  try {
    ...
    console.log('\n📚 Character Classes:');
    const { data: classes } = await supabase.from('character_classes').select('*');
    ...
    achievements?.forEach(a => console.log(`   - ${a.display_name} (${a.category})`));
    ...
    console.log('   Functions: ✅ Created (calculate_level, update_user_stats)');
