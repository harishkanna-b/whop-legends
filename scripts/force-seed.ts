...
async function forceSeedDatabase() {
	try {
			...
			.insert([
				{
					...
					display_name: "Scout",
					description:
						"Specializes in finding new referral opportunities with balanced XP and commission gains",
				...
				},
				{
					...
					display_name: "Sage",
					description:
						"Focuses on strategic referrals with quest bonuses and consistent performance",
					base_xp_multiplier: 1.1,
					commission_multiplier: Math.LOG2E,
				...
				},
				{
					...
					description:
						"Excels at high-value referrals with maximum XP multiplier",
		...
		if (achievementError) {
			...
			console.log(
				"✅ Achievements inserted successfully:",
		...
		const { data: quests, error: questError } = await supabase
			...
			.insert([
				...
				},
				{
					...
					description:
						"Build your network by completing 5 successful referrals",
					quest_type: "weekly",
					difficulty: "medium",
					target_type: "referrals",
					target_value: 5,
